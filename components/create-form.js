export default function CreateForm(props) {
    ...
    return (
        <form
            ...
            <legend className="text-2xl font-bold text-center">Create Cookie Stand</legend>

            <div className="flex py-4">
                <label className="mr-2 font-bold" htmlFor="location">Location</label>
            ...
            <div className="flex gap-2 text-center item-centereduce">
                ...
                <fieldset className="flex flex-col flex-1 min-w-0 p-2 ">
                    <label className= "font-bold" htmlFor="minimumCustomersPerHour">Minimum Customers per Hour</label>
                    <input className="pl-2" type="number" name="minimumCustomersPerHour" />
                </fieldset>

                <fieldset className="flex flex-col flex-1 min-w-0 p-2 ">
                    <label className= "font-bold" htmlFor="maximumCustomersPerHour">Maximum Customers per Hour</label>
                    <input className="pl-2" type="number" name="maximumCustomersPerHour" />
                </fieldset>

                <fieldset className="flex flex-col flex-1 min-w-0 p-2 ">
                    <label className= "font-bold" htmlFor="averageCookiesPerSale">Average Cookies per Sale</label>
                    <input className="pl-2" type="number" name="averageCookiesPerSale" step=".1" />
                </fieldset>
                <button type="submit" className="flex-1 min-w-0 font-bold bg-green-500 rounded-lg">Create</button>
            </div>
